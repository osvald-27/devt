    ...
    <div className="app-shell">
      ...
      <main className="content-area">
        <section id="home-view" className="view active">
          ...
          <div className="responsive-grid">
            ...
            <a href="tabs.html" className="cta-card" onClick={() => alert("Start Quiz!")}>
      ...
      <nav className="bottom-nav">
        <div className="nav-container">
          <a href="tabs.html" className="nav-link active" onClick={() => alert("Home!")}>
            <span className="material-symbols-rounded">home</span>
            <span>HOME</span>
          </a>
          <a href="tabs.html" className="nav-link" onClick={() => alert("Quizzes!")}>
            <span className="material-symbols-rounded">quiz</span>
            <span>QUIZZES</span>
          </a>
          <a href="tabs.html" className="nav-link" onClick={() => alert("Social!")}>
            <span className="material-symbols-rounded">forum</span>
            <span>SOCIAL</span>
          </a>
          <a href="tabs.html" className="nav-link" onClick={() => alert("Profile!")}>
